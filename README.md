...
|:--------:|:--------:|:------|
| 🤖 **Android** | [**akili.apk**](https://github.com/Nwokike/akili/releases/latest/download/akili.apk) | Universal APK (ARM64, ARMv7, x86_64) |
| 🪟 **Windows** | [**Akili_Setup.exe**](https://github.com/Nwokike/akili/releases/latest/download/Akili_Setup.exe) | Windows 10/11 (64-bit) |
...
```bash
# Clone
git clone https://github.com/Nwokike/akili.git
cd akili
